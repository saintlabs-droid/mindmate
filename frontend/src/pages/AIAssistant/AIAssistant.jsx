        ...
        <div className="flex-1 flex flex-col h-full bg-[#fcfcfc] dark:bg-background-dark overflow-hidden transition-colors duration-500">
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-white/5 bg-white/80 dark:bg-surface-dark/80 backdrop-blur-xl sticky top-0 z-10">
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <div className="w-10 h-10 bg-gradient-to-br from-primary to-[#ff9f8a] flex items-center justify-center shadow-lg shadow-primary/20">
                            <span className="material-icons text-white text-xl">auto_awesome</span>
                        </div>
                        <span className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 border-2 border-white dark:border-surface-dark shadow-sm"></span>
                    </div>
                    <div>
                        <h1 className="text-sm font-medium text-gray-900 dark:text-white leading-none">MindAI Companion</h1>
                        <p className="text-[10px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-1">Smart Support • Online</p>
                    </div>
                </div>
            ...
            <div className="flex-1 overflow-y-auto pt-6 px-4 pb-24 scroll-smooth chat-scroll">
                <div className="max-w-2xl mx-auto space-y-6">
                    ...
                    <div className="flex justify-center mb-8">
                        <span className="px-3 py-1 bg-gray-100 dark:bg-white/5 text-[9px] font-medium uppercase tracking-[0.2em] text-gray-400 dark:text-gray-500">Conversation Started</span>
                    </div>
                    ...
                    {mockMessages.map((msg) => (
                        ...
                        >
                            {msg.sender === 'ai' && (
                                <div className="w-8 h-8 bg-primary/5 dark:bg-primary/10 flex-shrink-0 flex items-center justify-center border border-primary/10 mt-1">
                            ...
                            <div className={`flex flex-col ${msg.sender === 'user' ? 'items-end' : 'items-start'} max-w-[80%]`}>
                                <div className={`
                                    px-4 py-3 text-[13px] leading-relaxed shadow-sm transition-all
                                    ${msg.sender === 'ai'
                                        ? 'bg-white dark:bg-surface-dark text-gray-700 dark:text-gray-200 border border-gray-100 dark:border-white/5'
                                        : 'bg-primary text-white shadow-orange-500/10'
                                    }
                                `}>
                                    {msg.content}
                                </div>
                                ...
                                {msg.chips && (
                                    <div className="flex flex-wrap gap-1.5 mt-3">
                                        {msg.chips.map(chip => (
                                            <button
                                                key={chip}
                                                className="px-3 py-1.5 bg-white dark:bg-surface-dark border border-gray-200 dark:border-white/10 text-primary hover:border-primary hover:bg-primary hover:text-white rounded-none text-[10px] font-medium transition-all shadow-sm active:scale-95"
                                            >
                                                {chip}
                                            </button>
                                        ))}
                                ...
                                <span className="text-[9px] font-medium text-gray-400 dark:text-gray-500 mt-1.5 uppercase tracking-tighter opacity-60">
                                    {msg.time}
                                </span>
                            </div>
                        </div>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-white dark:from-background-dark via-white/80 dark:via-background-dark/80 to-transparent">
                <div className="max-w-2xl mx-auto">
                    <div className="relative flex items-center gap-2 bg-white dark:bg-surface-dark shadow-xl border border-gray-200 dark:border-white/10 p-1.5 transition-all focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary/40">
                        <button 
                            className="p-2.5 text-gray-400 hover:text-primary transition-colors flex-shrink-0"
                        ...
                        <button 
                            className={`
                                p-2.5 transition-all flex-shrink-0 flex items-center justify-center
                    ...
                    <div className="mt-3 flex items-center justify-center gap-2 px-4 opacity-50">
                        ...
                        <p className="text-[9px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-widest text-center leading-none">
