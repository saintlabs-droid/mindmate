...
const InfluenceButton = ({ influence, isSelected, onClick }) => {
    return (
        <button
            onClick={onClick}
            className={`select-card group relative p-4 h-32 flex flex-col justify-between items-start rounded-lg border-2 transition-all text-left focus:outline-none 
                ${isSelected
